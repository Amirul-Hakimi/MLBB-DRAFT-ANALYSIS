...
const RAW_HERO_DATASET = [
    ...
    { id: "aurora", name: "Aurora", heroClass: ["Mage"], roles: { Mid: { pickRate: 0.30 } }, banRate: 0.03, winRate: 48.13, powerSpike: "Mid", image: "/assets/heroes/aurora.png" },
    ...
    { id: "belerick", name: "Belerick", heroClass: ["Tank"], roles: { EXP: { pickRate: 0.10 }, Roam: { pickRate: 0.98 } }, banRate: 60.00, winRate: 51.50, powerSpike: "Late", image: "/assets/heroes/belerick.png" },
    ...
    { id: "bruno", name: "Bruno", heroClass: ["Marksman"], roles: { Gold: { pickRate: 0.25 } }, banRate: 0.05, winRate: 49.17, powerSpike: "Late", image: "/assets/heroes/bruno.png" },

    // ==========================================
    // C
    // ==========================================
    { id: "carmilla", name: "Carmilla", heroClass: ["Support", "Tank"], roles: { Roam: { pickRate: 0.40 } }, banRate: 0.20, winRate: 50.13, powerSpike: "Mid", image: "/assets/heroes/carmilla.png" },
    ...
    { id: "change", name: "Chang'e", heroClass: ["Mage"], roles: { Mid: { pickRate: 0.30 } }, banRate: 0.01, winRate: 45.87, powerSpike: "Mid", image: "/assets/heroes/chang'e.png" },
    { id: "chip", name: "Chip", heroClass: ["Tank", "Support"], roles: { Roam: { pickRate: 0.25 } }, banRate: 0.50, winRate: 50.29, powerSpike: "Early", image: "/assets/heroes/chip.png" },
    { id: "chou", name: "Chou", heroClass: ["Fighter"], roles: { EXP: { pickRate: 0.10 }, Roam: { pickRate: 0.45 } }, banRate: 1.00, winRate: 45.87, powerSpike: "All", image: "/assets/heroes/chou.png" },
    ...
    { id: "dyrroth", name: "Dyrroth", heroClass: ["Fighter"], roles: { EXP: { pickRate: 0.20 }, Jungle: { pickRate: 0.10 } }, banRate: 0.05, winRate: 52.09, powerSpike: "Early", image: "/assets/heroes/dyrroth.png" },

    // ==========================================
    // E
    // ==========================================
    { id: "edith", name: "Edith", heroClass: ["Tank", "Marksman"], roles: { EXP: { pickRate: 0.10 }, Roam: { pickRate: 0.08 } }, banRate: 0.01, winRate: 49.84, powerSpike: "Mid", image: "/assets/heroes/edith.png" },
    ...
    { id: "estes", name: "Estes", heroClass: ["Support"], roles: { Roam: { pickRate: 0.50 } }, banRate: 8.00, winRate: 51.88, powerSpike: "Mid", image: "/assets/heroes/estes.png" },
    ...
    { id: "faramis", name: "Faramis", heroClass: ["Support", "Mage"], roles: { Mid: { pickRate: 0.10 }, Roam: { pickRate: 0.01 } }, banRate: 0.02, winRate: 51.08, powerSpike: "Mid", image: "/assets/heroes/faramis.png" },
    { id: "floryn", name: "Floryn", heroClass: ["Support"], roles: { Roam: { pickRate: 1.40 } }, banRate: 13.00, winRate: 53.68, powerSpike: "Mid", image: "/assets/heroes/floryn.png" },
    { id: "franco", name: "Franco", heroClass: ["Tank", "Support"], roles: { Roam: { pickRate: 0.03 } }, banRate: 0.02, winRate: 41.99, powerSpike: "Early", image: "/assets/heroes/franco.png" },
    { id: "fredrinn", name: "Fredrinn", heroClass: ["Tank", "Fighter"], roles: { Jungle: { pickRate: 0.55 }, EXP: { pickRate: 0.05 } }, banRate: 5.00, winRate: 51.83, powerSpike: "Mid", image: "/assets/heroes/fredrinn.png" },
    { id: "freya", name: "Freya", heroClass: ["Fighter"], roles: { EXP: { pickRate: 0.35 }, Jungle: { pickRate: 0.10 } }, banRate: 1.56, winRate: 50.06, powerSpike: "Early", image: "/assets/heroes/freya.png" },

    // ==========================================
    // G
    // ==========================================
    { id: "gatotkaca", name: "Gatotkaca", heroClass: ["Tank", "Fighter"], roles: { EXP: { pickRate: 0.15 }, Roam: { pickRate: 0.40 } }, banRate: 0.03, winRate: 44.45, powerSpike: "Mid", image: "/assets/heroes/gatotkaca.png" },
    { id: "gloo", name: "Gloo", heroClass: ["Tank"], roles: { EXP: { pickRate: 0.60 }, Roam: { pickRate: 0.29 } }, banRate: 50.00, winRate: 52.92, powerSpike: "Mid", image: "/assets/heroes/gloo.png" },
    ...
    { id: "grock", name: "Grock", heroClass: ["Tank", "Fighter"], roles: { Roam: { pickRate: 0.15 } }, banRate: 0.10, winRate: 46.87, powerSpike: "Early", image: "/assets/heroes/grock.png" },
    ...
    // H
    // ==========================================
    { id: "hanabi", name: "Hanabi", heroClass: ["Marksman"], roles: { Gold: { pickRate: 1.00 } }, banRate: 2.00, winRate: 51.31, powerSpike: "Late", image: "/assets/heroes/hanabi.png" },
    ...
    { id: "hilda", name: "Hilda", heroClass: ["Fighter", "Tank"], roles: { Roam: { pickRate: 0.25 }, EXP: { pickRate: 0.10 } }, banRate: 0.80, winRate: 48.69, powerSpike: "Early", image: "/assets/heroes/hilda.png" },
    ...
    // I
    // ==========================================
    { id: "irithel", name: "Irithel", heroClass: ["Marksman"], roles: { Gold: { pickRate: 0.50 } }, banRate: 0.10, winRate: 51.74, powerSpike: "Late", image: "/assets/heroes/irithel.png" },
    ...
    // J
    // ==========================================
    { id: "jawhead", name: "Jawhead", heroClass: ["Fighter"], roles: { Roam: { pickRate: 0.10 }, EXP: { pickRate: 0.05 } }, banRate: 0.02, winRate: 47.52, powerSpike: "Early", image: "/assets/heroes/jawhead.png" },
    { id: "johnson", name: "Johnson", heroClass: ["Tank", "Support"], roles: { Roam: { pickRate: 0.05 } }, banRate: 0.01, winRate: 47.39, powerSpike: "Mid", image: "/assets/heroes/johnson.png" },
    { id: "joy", name: "Joy", heroClass: ["Assassin", "Mage"], roles: { EXP: { pickRate: 0.03 }, Jungle: { pickRate: 0.30 } }, banRate: 0.22, winRate: 48.57, powerSpike: "Mid", image: "/assets/heroes/joy.png" },
    ...
    // K
    // ==========================================
    { id: "kadita", name: "Kadita", heroClass: ["Mage", "Assassin"], roles: { Mid: { pickRate: 0.30 }, Roam: { pickRate: 0.03 } }, banRate: 2.00, winRate: 51.65, powerSpike: "Early", image: "/assets/heroes/kadita.png" },
    ...
    { id: "kalea", name: "Kalea", heroClass: ["Support"], roles: { Roam: { pickRate: 0.20 } }, banRate: 0.05, winRate: 42.57, powerSpike: "Mid", image: "/assets/heroes/kalea.png" },
    ...
    { id: "khaleed", name: "Khaleed", heroClass: ["Fighter"], roles: { EXP: { pickRate: 0.24 }, Roam: { pickRate : 0.20} }, banRate: 0.05, winRate: 49.53, powerSpike: "Early", image: "/assets/heroes/khaleed.png" },
    ...
    { id: "lapu_lapu", name: "Lapu-Lapu", heroClass: ["Fighter"], roles: { EXP: { pickRate: 0.30 } }, banRate: 0.05, winRate: 47.71, powerSpike: "Mid", image: "/assets/heroes/lapu-lapu.png" },
    ...
    { id: "lesley", name: "Lesley", heroClass: ["Marksman", "Assassin"], roles: { Gold: { pickRate: 1.00 } }, banRate: 9.93, winRate: 47.54, powerSpike: "Late", image: "/assets/heroes/lesley.png" },
    ...
    { id: "luo_yi", name: "Luo Yi", heroClass: ["Mage"], roles: { Mid: { pickRate: 0.30 } }, banRate: 0.04, winRate: 45.99, powerSpike: "Early", image: "/assets/heroes/luo-yi.png" },
    { id: "lylia", name: "Lylia", heroClass: ["Mage"], roles: { Mid: { pickRate: 0.30 } }, banRate: 0.03, winRate: 47.36, powerSpike: "Early", image: "/assets/heroes/lylia.png" },
    ...
    { id: "martis", name: "Martis", heroClass: ["Fighter"], roles: { Jungle: { pickRate: 0.10 }, EXP: { pickRate: 0.15 } }, banRate: 0.03, winRate: 47.67, powerSpike: "Early", image: "/assets/heroes/martis.png" },
    ...
    { id: "mathilda", name: "Mathilda", heroClass: ["Support", "Assassin"], roles: { Roam: { pickRate: 0.30 }, Mid: { pickRate: 0.05 } }, banRate: 0.10, winRate: 44.91, powerSpike: "Early", image: "/assets/heroes/mathilda.png" },
    { id: "melissa", name: "Melissa", heroClass: ["Marksman"], roles: { Gold: { pickRate: 1.50 } }, banRate: 6.69, winRate: 58.17, powerSpike: "Late", image: "/assets/heroes/melissa.png" },
    ...
    // N
    // ==========================================
    { id: "nana", name: "Nana", heroClass: ["Mage", "Support"], roles: { Mid: { pickRate: 0.30 } }, banRate: 0.10, winRate: 45.14, powerSpike: "Mid", image: "/assets/heroes/nana.png" },
    { id: "natan", name: "Natan", heroClass: ["Marksman"], roles: { Gold: { pickRate: 0.30 } }, banRate: 0.03, winRate: 49.98, powerSpike: "Late", image: "/assets/heroes/natan.png" },
    { id: "natalia", name: "Natalia", heroClass: ["Assassin"], roles: { Roam: { pickRate: 0.10 }, Jungle: { pickRate: 0.10 } }, banRate: 0.20, winRate: 50.54, powerSpike: "Early", image: "/assets/heroes/natalia.png" },
    ...
    { id: "novaria", name: "Novaria", heroClass: ["Mage"], roles: { Mid: { pickRate: 0.30 } }, banRate: 0.05, winRate: 47.50, powerSpike: "Late", image: "/assets/heroes/novaria.png" },
    ...
    { id: "odette", name: "Odette", heroClass: ["Mage"], roles: { Mid: { pickRate: 0.30 } }, banRate: 0.02, winRate: 51.62, powerSpike: "Mid", image: "/assets/heroes/odette.png" },
    ...
    { id: "pharsa", name: "Pharsa", heroClass: ["Mage"], roles: { Mid: { pickRate: 0.40 } }, banRate: 0.05, winRate: 46.84, powerSpike: "Mid", image: "/assets/heroes/pharsa.png" },
    ...
    { id: "popol_and_kupa", name: "Popol and Kupa", heroClass: ["Marksman"], roles: { Gold: { pickRate: 0.15 }, Jungle: { pickRate: 0.02 } }, banRate: 0.02, winRate: 50.99, powerSpike: "Early", image: "/assets/heroes/popol-and-kupa.png" },
    ...
    { id: "roger", name: "Roger", heroClass: ["Fighter", "Marksman"], roles: { Jungle: { pickRate: 0.25 }, Gold: { pickRate: 0.05 } }, banRate: 0.03, winRate: 46.00, powerSpike: "Mid", image: "/assets/heroes/roger.png" },
    ...
    { id: "selena", name: "Selena", heroClass: ["Assassin", "Mage"], roles: { Roam: { pickRate: 0.03 }, Mid: { pickRate: 0.30 } }, banRate: 1.00, winRate: 47.13, powerSpike: "Early", image: "/assets/heroes/selena.png" },
    ...
    { id: "suyou", name: "Suyou", heroClass: ["Assassin", "Fighter"], roles: { Jungle: { pickRate: 0.60 }, EXP: { pickRate: 0.01 } }, banRate: 2.14, winRate: 48.38, powerSpike: "Mid", image: "/assets/heroes/suyou.png" },
    ...
    // U
    // ==========================================
    { id: "uranus", name: "Uranus", heroClass: ["Tank"], roles: { EXP: { pickRate: 0.40 } }, banRate: 0.38, winRate: 50.05, powerSpike: "Mid", image: "/assets/heroes/uranus.png" },

    // ==========================================
    // V
    // ==========================================
    { id: "vale", name: "Vale", heroClass: ["Mage"], roles: { Mid: { pickRate: 0.25 } }, banRate: 0.01, winRate: 48.92, powerSpike: "Mid", image: "/assets/heroes/vale.png" },
    { id: "valentina", name: "Valentina", heroClass: ["Mage"], roles: { Mid: { pickRate: 0.40 } }, banRate: 0.10, winRate: 45.34, powerSpike: "Mid", image: "/assets/heroes/valentina.png" },
    ...
    // W
    // ==========================================
    { id: "wanwan", name: "Wanwan", heroClass: ["Marksman"], roles: { Gold: { pickRate: 0.03 } }, banRate: 0.01, winRate: 46.71, powerSpike: "Late", image: "/assets/heroes/wanwan.png" },

    // ==========================================
    // X
    // ==========================================
    { id: "x_borg", name: "X.Borg", heroClass: ["Fighter"], roles: { EXP: { pickRate: 0.20 }, Jungle: { pickRate: 0.25 } }, banRate: 0.30, winRate: 48.28, powerSpike: "Mid", image: "/assets/heroes/x-borg.png" },
    ...
    { id: "yve", name: "Yve", heroClass: ["Mage"], roles: { Mid: { pickRate: 0.42 } }, banRate: 0.04, winRate: 50.93, powerSpike: "Mid", image: "/assets/heroes/yve.png" },
